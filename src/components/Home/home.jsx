...
class Home extends React.Component {
    ...
    render() { 
        ...
        <div id='slide-container' className='home-slider'>
            ...
            Over the years, the academy has been training scores of students who come from all walks of life and nurtured their passion while creating awareness for leading a healthy lifestyle.</li>
